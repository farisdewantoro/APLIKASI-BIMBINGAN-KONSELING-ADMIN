...
import {getAllPertanyaan} from '../../../actions/pertanyaanActions';
 class Konsultasi extends Component {
     ...
     handlerChangeQuestion = (hasilJawaban,pertanyaan,jurusan)=>{
         let hasilAkhir = [];
     ...
     componentDidUpdate(prevProps, prevState, snapshot){
         if (this.state.hasilJawaban !== prevState.hasilJawaban 
            || this.state.pertanyaan !== prevState.pertanyaan
            || this.state.jurusan !== prevState.jurusan
            ){
             this.handlerChangeQuestion(this.state.hasilJawaban,this.state.pertanyaan,this.state.jurusan);
         }
  ...
  render() {
      ...
      let formContainer; 
        ...
        } else if (pertanyaan.length > 0 && endQuestion ==false ){
            formContainer=(
                <Grid item>
